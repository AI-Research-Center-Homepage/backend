...
public class Graduate extends Member {
    ...
    @Builder
    public Graduate(Long id, String name, String major, String email, String image, List<Member_Thesis> theses, List<Image> profile, List<Image> images, String admission) {
